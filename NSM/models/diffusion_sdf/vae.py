# https://github.com/princeton-computational-imaging/Diffusion-SDF/blob/64dc177a43517d17077e6ff7d16160cf64e78255/train_sdf/models/autoencoder.py
import torch
...
class BetaVAE(nn.Module):
    ...
    def decode(self, z: Tensor) -> Tensor:
        ...
        bottleneck_size = self.plane_resolution/(2**len(self.hidden_dims))

        result = self.decoder_input(z) # ([32, D*4])
        result = result.view(-1, int(result.shape[-1]/bottleneck_size), bottleneck_size, bottleneck_size)  # for plane features resolution 64x64, spatial resolution is 2x2 after the last encoder layer
