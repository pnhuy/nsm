#https://github.com/princeton-computational-imaging/Diffusion-SDF/blob/64dc177a43517d17077e6ff7d16160cf64e78255/train_sdf/models/archs/sdf_decoder.py
#!/usr/bin/env python3
...
class ModulatedMLP(nn.Module):
    ...
    def pe_transform(self, data):
        raise NotImplementedError('pe_transform not implemented')
    ...
    def forward(self, xyz, latent):
        ...
        for i, layer in enumerate(self.net):
            ...
            if i in self.skip_connection:
                x = torch.cat(( x, torch.cat((xyz, latent),dim=-1)), dim=-1)
